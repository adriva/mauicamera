...
using CustomRenderer = Adriva.Camera.Maui.ZXing.Platforms.Windows.SoftwareBitmapRenderer;
#elif IOS || MACCATALYST
using CustomRenderer = Adriva.Camera.Maui.ZXing.Platforms.Apple.BitmapRenderer;
#elif ANDROID
using CustomRenderer = Adriva.Camera.Maui.ZXing.Platforms.Android.BitmapRenderer;
#else
using CustomRenderer = System.Object;
#endif

namespace Adriva.Camera.Maui.ZXing;
